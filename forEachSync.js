...
var workerMulti = function(concurrency,array, callback, compliteCallBack) {
    var index = 0; //游标
    var q = async.queue(function(item, cb) {
      var cback = function() {
          index = index + 1;
...
Array.prototype.forMultiSync = function(concurrency,callback, compliteCallBack) {
  new workerMulti(concurrency,this, callback, compliteCallBack);
}